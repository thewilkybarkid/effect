...
/** @internal */
export const collectAllUntilEffect = <In, R, E>(p: (input: In) => Effect<R, E, boolean>) => {
  return pipe(
...
export const contextWithEffect = <R0, R, E, Z>(
  f: (context: Context.Context<R0>) => Effect<R, E, Z>
...
/** @internal */
export const forEach = <In, R, E, _>(f: (input: In) => Effect<R, E, _>): Sink.Sink<R, E, In, never, void> => {
...
/** @internal */
export const fromEffect = <R, E, Z>(effect: Effect<R, E, Z>): Sink.Sink<R, E, unknown, never, Z> =>
...
export const serviceWithEffect = <T extends Context.Tag<any, any>, R, E, Z>(
  tag: T,
  f: (service: Context.Tag.Service<T>) => Effect<R, E, Z>
...
export const toChannel = <R, E, In, L, Z>(
  ...
  Effect.isEffect(self) ?
    toChannel(fromEffect(self as Effect<R, E, Z>)) :
    (self as SinkImpl<R, E, In, L, Z>).channel

/** @internal */
export const unwrap = <R, E, R2, E2, In, L, Z>(
  effect: Effect<R, E, Sink.Sink<R2, E2, In, L, Z>>
...
export const unwrapScoped = <R, E, In, L, Z>(
  effect: Effect<R, E, Sink.Sink<R, E, In, L, Z>>
): Sink.Sink<Exclude<R, Scope.Scope>, E, In, L, Z> => {
