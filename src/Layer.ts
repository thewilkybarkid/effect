...
) => Effect<Scope.Scope | RIn, E, Context.Context<ROut>> = internal.build
 ...
 * @category constructors
 */
export const effectContext: <R, E, A>(effect: Effect<R, E, Context.Context<A>>) => Layer<R, E, A> =
...
export const memoize: <RIn, E, ROut>(
  self: Layer<RIn, E, ROut>
) => Effect<Scope.Scope, never, Layer<RIn, E, ROut>> = internal.memoize
 ...
 * @category constructors
 */
export const scopedDiscard: <R, E, T>(effect: Effect<R, E, T>) => Layer<Exclude<R, Scope.Scope>, E, never> =
...
export const toRuntime: <RIn, E, ROut>(
  self: Layer<RIn, E, ROut>
) => Effect<Scope.Scope | RIn, E, Runtime.Runtime<ROut>> = internal.toRuntime
